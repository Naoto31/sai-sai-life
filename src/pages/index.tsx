      ...
      >
        ...
        <div className='w-full  h-full'>
          ...
          <div className='w-full h-10 mt-14 flex justify-center items-center'>
            <div
              className={
                'w-4 h-4 mx-2 rounded-full cursor-pointer ' + (page === 1 ? 'bg-white' : 'bg-gray-400')
              }
              onClick={() => {
                setPage(1);
              }}
            ...
            <div
              className={
                'w-4 h-4 mx-2 rounded-full cursor-pointer ' + (page === 2 ? 'bg-white' : 'bg-gray-400')
              }
              onClick={() => {
                setPage(2);
              }}
            ...
            <div
              className={
                'w-4 h-4 mx-2 rounded-full cursor-pointer ' + (page === 3 ? 'bg-white' : 'bg-gray-400')
              }
              onClick={() => {
                setPage(3);
              }}
